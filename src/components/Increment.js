...
export const Increment = ({ qty, onUpdateCartQty, id }) => {
  ...
  return (
    ...
    <Box style={{ display: 'flex'}}>
      { qty <= 1 && <Button m={1} style={{maxWidth: '40px', maxHeight: '40px', minWidth: '40px', minHeight: '40px'}} variant="outlined" disabled>-</Button>} 
      { qty > 1 && <Button m={1} style={{maxWidth: '40px', maxHeight: '40px', minWidth: '40px', minHeight: '40px'}} variant="outlined" onClick={() => {
